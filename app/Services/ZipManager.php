...
class ZipManager
{
     ...
     *
     * @param \App\Services\Zip $zip
     *
     * @return $this
     */
    public function addZip(\App\Services\Zip $zip)
    {
     ...
     * @param \App\Services\Zip $zip
     *
     * @return \App\Services\ZipManager
     */
    public function removeZip(\App\Services\Zip $zip)
    {
