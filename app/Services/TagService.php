...
*/
    ...
    public function getAllTags($class = null): Collection
    {
        ...
        $sql = 'SELECT DISTINCT t.* FROM taggables tt LEFT JOIN tags t ON tt.tag_id=t.tag_id' .
    ...
    {
        $sql = 'SELECT t.* FROM tags t LEFT JOIN taggables tt ON tt.tag_id=t.tag_id ' .
    ...
    {
        $sql = 'SELECT t.*, COUNT(t.tag_id) AS taggable_count FROM tags t LEFT JOIN taggables tt ON tt.tag_id=t.tag_id';
        $bindings = [];
