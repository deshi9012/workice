...
class MysqlRestore extends Command
{
    ...
    {
        parent::__construct();
        $this->mysqlPath = config('mysql-restore.mysql.mysql_path', 'mysql');
        $this->connection = [
        ...
        $this->localDisk = config('mysql-restore.mysql.local-storage.disk', 'local');
        $this->localPath = config('mysql-restore.mysql.local-storage.path', null);
        $this->cloudDisk = config('mysql-restore.mysql.cloud-storage.disk', null);
        $this->cloudPath = config('mysql-restore.mysql.cloud-storage.path', null);
    }
    /**
