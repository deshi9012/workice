			...
			<section class="vbox">
				...
				<header class="header panel-heading bg-white b-b b-light">
					...
					<a href="<?php echo e(route('users.export')); ?>"
					   ...
					   title="<?php echo trans('app.'.'export'); ?> CSV">
					...
					<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('users_create')): ?>
						<a href="<?php echo e(route('users.create')); ?>"
						   class="btn btn-sm btn-<?php echo e(get_option('theme_color')); ?> pull-right" data-toggle="ajaxModal">
					...
					<?php if(isAdmin() || can('announcements_create')): ?>
						<a href="<?php echo e(route('announcements.index')); ?>"
						   class="btn btn-sm btn-<?php echo e(get_option('theme_color')); ?> pull-right" data-rel="tooltip"
						   title="<?php echo trans('app.'.'announcements'); ?>" data-placement="bottom">
						...
						<form id="frm-user" method="POST">
							...
							<div class="table-responsive">
								...
								<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('users_delete')): ?>
									<button type="submit" id="button" class="btn btn-sm btn-danger m-xs"
											value="bulk-delete">
