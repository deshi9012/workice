        ...
        <div class="modal-body">
            ...
            <div class="tab-content">
                <div class="tab-pane fade in active" id="tab-lead-general">
                    <div class="form-group col-md-6 no-gutter-left">
                        ...
                        <input type="text" name="name" value="<?php echo e($lead->name); ?>" class="input-sm form-control" required>
                    </div>
                    <div class="form-group col-md-6 no-gutter-right">
                        <label><?php echo trans('app.'.'email'); ?>  <span class="text-danger">*</span></label>
                        <input type="email" name="email" value="<?php echo e($lead->email); ?>" class="input-sm form-control" required>
                    </div>
                    <div class="form-group col-md-6 no-gutter-left">
                    ...
                    <div class="row">
                        ...
                        <input type="text" value="<?php echo e($lead->lead_score); ?>" name="lead_score" class="input-sm form-control">
                    </div>
                    <div class="form-group col-md-6">
                        <label><?php echo trans('app.'.'lead_value'); ?></label>
                        <input type="text" value="<?php echo e($lead->lead_value); ?>" name="lead_value" class="input-sm form-control">
                    </div>
                    <div class="form-group col-md-6">
            ...
            <div class="tab-pane fade in" id="tab-lead-message">
                <div class="form-group">
                    ...
                    <textarea name="message" class="form-control markdownEditor" required><?php echo e($lead->message); ?> </textarea>
                </div>
