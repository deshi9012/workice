<script type="text/javascript" src="<?php echo e(getAsset('plugins/sortable/jquery-sortable.js')); ?>"></script>
    <script type="text/javascript">
        ...
        function saveOrder() {
            ...
            axios.post('<?php echo e(route('items.reorder')); ?>', {
                "json": items,
                "table": table
            })
        ...
        function saveMenu(table, access) {
            ...
            var items = JSON.stringify(data);
            $.ajax({
                url: "<?php echo e(route('menu.reorder')); ?>",
                type: "POST",
                dataType: 'json',
                data: {_token: '<?php echo e(csrf_token()); ?>', json: items},
        ...
        function setCron() {
            ...
            var items = JSON.stringify(data);
            $.ajax({
                url: "<?php echo e(site_url()); ?>/settings/hook/reorder/1",
                type: "POST",
                dataType: 'json',
                data: {json: items},
                success: function () {
