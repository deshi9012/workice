<section class="" id="taskapp">
    <aside>
        <section class="">
            ...
            <header class="header">
                <a href="{{ route('extras.call.create', ['module' => 'leads', 'id' => $lead->id]) }}" data-toggle="ajaxModal" class="btn btn-success btn-sm pull-right btn-icon" id="new-call" data-rel="tooltip" title="@langapp('log_call')">
                    @icon('solid/phone')
                </a>
