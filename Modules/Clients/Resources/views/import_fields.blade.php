                ...
                <header class="header bg-white b-b clearfix">
                    <div class="row m-t-sm">
                        ...
                        <div class="col-sm-7 m-b-xs">
                            <a href="{{ route('clients.export') }}" class="btn btn-sm btn-info pull-right">
                ...
                <section class="scrollable wrapper bg">
                    <section class="panel panel-default">
                        <div class="panel-body">
                            {!! Form::open(['route' => 'clients.csvprocess', 'class' => 'form-horizontal ajaxifyForm']) !!}
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="fields[{{ $key }}]" class="form-control">
                                                    ...
                                                    @foreach (config('db-fields.client') as $db_field)
