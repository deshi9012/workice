				...
				<div class="form-group">
					{{--<div class="row">--}}
						...
						{{--<div class="col-md-4">--}}
							...
							{{--<input type="text" value="{{  $user->profile->zip_code  }}" name="zip_code"--}}
								   {{--class="form-control">--}}
						{{--</div>--}}
					{{--</div>--}}
				</div>
				...
				<div class="form-group">
					{{--<div class="row">--}}
						...
						{{--<div class="col-md-6">--}}
							...
							{{--<input type="text" value="{{  $user->profile->mobile  }}" name="mobile"--}}
								   {{--class="form-control">--}}
						{{--</div>--}}
					{{--</div>--}}
				</div>
				...
				<div class="form-group">
					{{--<div class="row">--}}
						{{--<div class="col-md-6">--}}
							...
							{{--<input type="text" class="form-control" value="{{ $user->profile->hourly_rate }}"--}}
								   {{--name="hourly_rate">--}}
						{{--</div>--}}
