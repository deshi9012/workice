    ...
    <section class="panel panel-default b-top">
        <header class="panel-heading h3">
            ...
            @can('events_create') 
                ...
                <a href="{{  route('calendar.create', ['module' => 'deals', 'id' => $deal->id])  }}"
                   class="btn btn-xs btn-{{ get_option('theme_color') }} pull-right" data-toggle="ajaxModal"> @icon('solid/calendar-plus') @langapp('schedule_event')  </a>
                ...
                },
                {
                    events: [
                        ...
                        @endforeach
                        {
                            ...
                            url: '{{  route('deals.edit', ['id' => $deal->id])  }}',
                            color: '#f6993f'
                        },
                    ],
                    textColor: 'white'
